...
% The 2D FFT implementation is already provided here. This will run a 2D FFT
...
figure('Name', 'The output of the 2D CFAR process'), surf(doppler_axis, range_axis, CFAR_2D);
colorbar;
